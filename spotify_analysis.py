...
# Bellow we bring everything together to plot our findings to a file.
...
text_file.write(
    'Bellow you can find the messages clustered in 10 different Topics represented by a list of words.')
text_file.write('\n')
text_file.write('\n')
